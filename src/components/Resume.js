        ...
        <div id="resume">
          ...
          <div id="resume-box">
            ...
            >
              ...
              <li>Manage all aspects of the software development lifecycle</li>
              <li>
              ...
              <li>
                Ensure that the proper requirements are defined, understood, and
                developed
              </li>
              <li>
            ...
            >
              ...
              <li>
                Provided guidance, direction, and feedback for Advent marketing
                team
              </li>
            ...
            >
              ...
              <li>
                Planned and executed trade show presence for multiple shows and
                two brands, including booth design
              </li>
            ...
            >
              <li>
                Responsible for launching more than 45 websites within timelines
                and with results beyond expectations
              </li>
              <li>
                Analyzed site metrics and trends in order to help direct clients
                in organization and development of website redesigns
              </li>
              <li>
                Created project plans and timelines, and documented requirements
              </li>
              <li>
                Acted as the go-between for the client and the development team
              </li>
            </Position>
            <Position
              companyName={'Journal Communications/Journal Interactive'}
            ...
            >
              ...
              <li>
                Created feature comparison charts for use in evaluating current
                and potential vendor relationships
              </li>
              <li>
            ...
            >
              ...
              <li>
                Worked with editors to help coordinate online coverage daily and
            ...
            >
              ...
              <li>
                Developed and maintained overall vision of progress for website
              </li>
            </Position>
          </div>
